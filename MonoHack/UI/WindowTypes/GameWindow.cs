...
namespace MonoHack.UI
{
    ...
    {
        Control WindowPanel = new Controls.Panel();
        Control TitleBar = new Controls.Panel();
        Control Title = new Controls.Label();
        Control btnClose = new Controls.Button();
        Control btnMax = new Controls.Button();
        Control btnMin = new Controls.Button();
        ...
        public GameWindow(SpriteBatch _spriteBatch, ContentManager _content, GraphicsDevice _graphicsDevice, Applications.IMonoHackApp App)
        {
            ...
            WindowPanel.Theme = new UI.Themes.DefaultTheme(_content, _spriteBatch);
            ...
            TitleBar.Theme = new UI.Themes.DefaultTheme(_content, _spriteBatch);
            ...
            Title.Theme = new UI.Themes.DefaultTheme(_content, _spriteBatch);
            ...
            btnClose.Theme = new UI.Themes.DefaultTheme(_content, _spriteBatch);
            ...
            btnMax.Theme = new UI.Themes.DefaultTheme(_content, _spriteBatch);
            ...
            btnMin.Theme = new UI.Themes.DefaultTheme(_content, _spriteBatch);
